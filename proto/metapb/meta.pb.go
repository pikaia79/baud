...
type Zone struct {
	...
	EtcdAddr    string `protobuf:"bytes,2,opt,name=etcd_addr,json=etcdAddr,proto3" json:"etcd_addr,omitempty"`
	EtcdRootDir string `protobuf:"bytes,3,opt,name=etcd_root_dir,json=etcdRootDir,proto3" json:"etcd_root_dir,omitempty"`
}
...
func (*ReplicaAddrs) Descriptor() ([]byte, []int) { return fileDescriptorMeta, []int{8} }
...
func (this *Zone) Equal(that interface{}) bool {
	...
	if this.EtcdAddr != that1.EtcdAddr {
		return false
	}
	if this.EtcdRootDir != that1.EtcdRootDir {
		return false
	}
	return true
}
...
func (m *Zone) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EtcdAddr) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintMeta(dAtA, i, uint64(len(m.EtcdAddr)))
		i += copy(dAtA[i:], m.EtcdAddr)
	}
	if len(m.EtcdRootDir) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintMeta(dAtA, i, uint64(len(m.EtcdRootDir)))
		i += copy(dAtA[i:], m.EtcdRootDir)
	}
	return i, nil
}
...
func NewPopulatedZone(r randyMeta, easy bool) *Zone {
	...
	this.EtcdAddr = string(randStringMeta(r))
	this.EtcdRootDir = string(randStringMeta(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func (this *Zone) String() string {
	...
	s := strings.Join([]string{`&Zone{`,
		...
		`EtcdAddr:` + fmt.Sprintf("%v", this.EtcdAddr) + `,`,
		`EtcdRootDir:` + fmt.Sprintf("%v", this.EtcdRootDir) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Zone) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EtcdRootDir", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EtcdRootDir = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorMeta = []byte{
	...
	,
}
