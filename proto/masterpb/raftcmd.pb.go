...
func (this *RaftKvPair) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&masterpb.RaftKvPair{")
	s = append(s, "Key: "+fmt.Sprintf("%#v", this.Key)+",\n")
	s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	s = append(s, "Timestamp: "+fmt.Sprintf("%#v", this.Timestamp)+",\n")
	s = append(s, "ApplyIndex: "+fmt.Sprintf("%#v", this.ApplyIndex)+",\n")
	s = append(s, "}")
...
func (this *GetRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&masterpb.GetRequest{")
	s = append(s, "Key: "+fmt.Sprintf("%#v", this.Key)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *GetResponse) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&masterpb.GetResponse{")
...
func (this *PutRequest) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&masterpb.PutRequest{")
	s = append(s, "Key: "+fmt.Sprintf("%#v", this.Key)+",\n")
	s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
...
func (this *PutResponse) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&masterpb.PutResponse{")
	s = append(s, "Code: "+fmt.Sprintf("%#v", this.Code)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *DeleteRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&masterpb.DeleteRequest{")
	s = append(s, "Key: "+fmt.Sprintf("%#v", this.Key)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *DeleteResponse) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&masterpb.DeleteResponse{")
	s = append(s, "Code: "+fmt.Sprintf("%#v", this.Code)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *KvPairExecute) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&masterpb.KvPairExecute{")
	s = append(s, "Do: "+fmt.Sprintf("%#v", this.Do)+",\n")
	if this.KvPair != nil {
...
func (this *ExecuteRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&masterpb.ExecuteRequest{")
	if this.Execs != nil {
		s = append(s, "Execs: "+fmt.Sprintf("%#v", this.Execs)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ExecuteResponse) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&masterpb.ExecuteResponse{")
	s = append(s, "Code: "+fmt.Sprintf("%#v", this.Code)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *Request) GoString() string {
	...
	s := make([]string, 0, 9)
	s = append(s, "&masterpb.Request{")
	s = append(s, "CmdType: "+fmt.Sprintf("%#v", this.CmdType)+",\n")
	if this.GetReq != nil {
		s = append(s, "GetReq: "+fmt.Sprintf("%#v", this.GetReq)+",\n")
	}
	if this.PutReq != nil {
		s = append(s, "PutReq: "+fmt.Sprintf("%#v", this.PutReq)+",\n")
	}
	if this.DeleteReq != nil {
		s = append(s, "DeleteReq: "+fmt.Sprintf("%#v", this.DeleteReq)+",\n")
	}
	if this.ExecuteReq != nil {
		s = append(s, "ExecuteReq: "+fmt.Sprintf("%#v", this.ExecuteReq)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *Response) GoString() string {
	...
	s := make([]string, 0, 9)
	s = append(s, "&masterpb.Response{")
	s = append(s, "CmdType: "+fmt.Sprintf("%#v", this.CmdType)+",\n")
	if this.GetResp != nil {
		s = append(s, "GetResp: "+fmt.Sprintf("%#v", this.GetResp)+",\n")
	}
	if this.PutResp != nil {
		s = append(s, "PutResp: "+fmt.Sprintf("%#v", this.PutResp)+",\n")
	}
	if this.DeleteResp != nil {
		s = append(s, "DeleteResp: "+fmt.Sprintf("%#v", this.DeleteResp)+",\n")
	}
	if this.ExecuteResp != nil {
		s = append(s, "ExecuteResp: "+fmt.Sprintf("%#v", this.ExecuteResp)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func valueToGoStringRaftcmd(v interface{}, typ string) string {
...
var fileDescriptorRaftcmd = []byte{
	...
	0xd0, 0xd0, 0x58, 0xeb, 0xdd, 0x89, 0xb1, 0xfc, 0xb1, 0x93, 0xdd, 0x59, 0x13, 0x77, 0x94, 0x94,
	0xfc, 0x07, 0x1a, 0x7e, 0x02, 0x25, 0x65, 0x4a, 0x4a, 0x24, 0x9a, 0xd8, 0x34, 0x94, 0x94, 0x94,
	...
	0x31, 0xf6, 0xee, 0x9c, 0x8f, 0x88, 0xf1, 0x79, 0x44, 0x8c, 0x8b, 0x11, 0x31, 0xbe, 0x8f, 0x08,
	0xfa, 0x31, 0x22, 0xe8, 0xf5, 0x98, 0xa0, 0xf7, 0x63, 0x82, 0x3e, 0x8c, 0x89, 0xf1, 0x71, 0x4c,
	0x8c, 0xf3, 0x31, 0x41, 0x9f, 0xc6, 0x04, 0x5d, 0x8c, 0x09, 0x7a, 0xfb, 0x95, 0x18, 0xf7, 0xd1,
	0x8b, 0x52, 0xcf, 0x4f, 0x04, 0x8b, 0x79, 0xb3, 0x59, 0x54, 0x9f, 0xcc, 0xdd, 0x9f, 0x01, 0x00,
	0x00, 0xff, 0xff, 0x10, 0x7c, 0x4d, 0xc6, 0x72, 0x05, 0x00, 0x00,
}
