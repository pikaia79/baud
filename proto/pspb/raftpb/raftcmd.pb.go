...
type RaftCommand struct {
	...
	DataRequest *api.BulkRequest `protobuf:"bytes,2,opt,name=data_request,json=dataRequest" json:"data_request,omitempty"`
}
...
func (this *RaftCommand) Equal(that interface{}) bool {
	...
	if !this.DataRequest.Equal(that1.DataRequest) {
		return false
	}
	return true
}
...
func (m *RaftCommand) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DataRequest != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintRaftcmd(dAtA, i, uint64(m.DataRequest.Size()))
		n1, err := m.DataRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
...
func NewPopulatedRaftCommand(r randyRaftcmd, easy bool) *RaftCommand {
	...
	if r.Intn(10) != 0 {
		this.DataRequest = api.NewPopulatedBulkRequest(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (this *RaftCommand) String() string {
	...
	s := strings.Join([]string{`&RaftCommand{`,
		...
		`DataRequest:` + strings.Replace(fmt.Sprintf("%v", this.DataRequest), "BulkRequest", "api.BulkRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorRaftcmd = []byte{
	...
	,
}
