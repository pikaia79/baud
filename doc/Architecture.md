...
Field: key -> a scalar value or a nested structure
...
Mapping is about the field types, index, analyzer etc., and it is defined explicitly, or generated automatically
