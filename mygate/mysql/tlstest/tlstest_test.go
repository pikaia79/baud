...
import (
	...
	baudtls "github.com/tiglabs/baudengine/mygate/mysql/tls"
)
...
func TestClientServer(t *testing.T) {
	...
	serverConfig, err := baudtls.ServerConfig(
	...
	clientConfig, err := baudtls.ClientConfig(
	...
	badClientConfig, err := baudtls.ClientConfig(
		path.Join(root, "server-instance-cert.pem"),
		path.Join(root, "server-instance-key.pem"),
		path.Join(root, "servers-cert.pem"),
		"Server Instance")
