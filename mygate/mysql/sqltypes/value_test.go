...
// newTestValue builds a Value from typ and val.
// This function should only be used for testing.
func newTestValue(typ querypb.Type, val string) Value {
...
func TestNewValue(t *testing.T) {
	testcases := []struct {
		...
		inType: Int8,
		inVal:  "1",
		outVal: newTestValue(Int8, "1"),
	}, {
		inType: Int16,
		inVal:  "1",
		outVal: newTestValue(Int16, "1"),
	}, {
		inType: Int24,
		inVal:  "1",
		outVal: newTestValue(Int24, "1"),
	}, {
		inType: Int32,
		inVal:  "1",
		outVal: newTestValue(Int32, "1"),
	}, {
		inType: Int64,
		inVal:  "1",
		outVal: newTestValue(Int64, "1"),
	}, {
		inType: Uint8,
		inVal:  "1",
		outVal: newTestValue(Uint8, "1"),
	}, {
		inType: Uint16,
		inVal:  "1",
		outVal: newTestValue(Uint16, "1"),
	}, {
		inType: Uint24,
		inVal:  "1",
		outVal: newTestValue(Uint24, "1"),
	}, {
		inType: Uint32,
		inVal:  "1",
		outVal: newTestValue(Uint32, "1"),
	}, {
		inType: Uint64,
		inVal:  "1",
		outVal: newTestValue(Uint64, "1"),
	}, {
		inType: Float32,
		inVal:  "1.00",
		outVal: newTestValue(Float32, "1.00"),
	}, {
		inType: Float64,
		inVal:  "1.00",
		outVal: newTestValue(Float64, "1.00"),
	}, {
		inType: Decimal,
		inVal:  "1.00",
		outVal: newTestValue(Decimal, "1.00"),
	}, {
		inType: Timestamp,
		inVal:  "2012-02-24 23:19:43",
		outVal: newTestValue(Timestamp, "2012-02-24 23:19:43"),
	}, {
		inType: Date,
		inVal:  "2012-02-24",
		outVal: newTestValue(Date, "2012-02-24"),
	}, {
		inType: Time,
		inVal:  "23:19:43",
		outVal: newTestValue(Time, "23:19:43"),
	}, {
		inType: Datetime,
		inVal:  "2012-02-24 23:19:43",
		outVal: newTestValue(Datetime, "2012-02-24 23:19:43"),
	}, {
		inType: Year,
		inVal:  "1",
		outVal: newTestValue(Year, "1"),
	}, {
		inType: Text,
		inVal:  "a",
		outVal: newTestValue(Text, "a"),
	}, {
		inType: Blob,
		inVal:  "a",
		outVal: newTestValue(Blob, "a"),
	}, {
		inType: VarChar,
		inVal:  "a",
		outVal: newTestValue(VarChar, "a"),
	}, {
		inType: Binary,
		inVal:  "a",
		outVal: newTestValue(Binary, "a"),
	}, {
		inType: Char,
		inVal:  "a",
		outVal: newTestValue(Char, "a"),
	}, {
		inType: Bit,
		inVal:  "1",
		outVal: newTestValue(Bit, "1"),
	}, {
		inType: Enum,
		inVal:  "a",
		outVal: newTestValue(Enum, "a"),
	}, {
		inType: Set,
		inVal:  "a",
		outVal: newTestValue(Set, "a"),
	}, {
		inType: VarBinary,
		inVal:  "a",
		outVal: newTestValue(VarBinary, "a"),
	}, {
		inType: Int64,
		inVal:  InvalidNeg,
		outErr: "out of range",
...
func TestIntegralValue(t *testing.T) {
	testcases := []struct {
		...
		in:     MinNeg,
		outVal: newTestValue(Int64, MinNeg),
	}, {
		in:     "1",
		outVal: newTestValue(Int64, "1"),
	}, {
		in:     MinPos,
		outVal: newTestValue(Uint64, MinPos),
	}, {
		in:     InvalidPos,
		outErr: "out of range",
	}}
...
func TestInerfaceValue(t *testing.T) {
	testcases := []struct {
		...
		in:  []byte("a"),
		out: newTestValue(VarBinary, "a"),
	}, {
		in:  int64(1),
		out: newTestValue(Int64, "1"),
	}, {
		in:  uint64(1),
		out: newTestValue(Uint64, "1"),
	}, {
		in:  float64(1.2),
		out: newTestValue(Float64, "1.2"),
	}, {
		in:  "a",
		out: newTestValue(VarChar, "a"),
	}}
	for _, tcase := range testcases {
...
func TestEncode(t *testing.T) {
	testcases := []struct {
		...
		in:       newTestValue(Int64, "1"),
		outSQL:   "1",
		outASCII: "1",
	}, {
		in:       newTestValue(VarChar, "foo"),
		outSQL:   "'foo'",
		outASCII: "'Zm9v'",
	}, {
		in:       newTestValue(VarChar, "\x00'\"\b\n\r\t\x1A\\"),
		outSQL:   "'\\0\\'\\\"\\b\\n\\r\\t\\Z\\\\'",
